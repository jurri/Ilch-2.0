<?php
class Users {
	public $table_name = 'ilch_users';
	
	function __construct(){
		//database configuration
		$dbServer = 'localhost'; //Define database server host
		$dbUsername = 'web138'; //Define database username
		$dbPassword = 'IrfEmGmfl2LGerP7BlUU'; //Define database password
		$dbName = 'web138_db8'; //Define database name
